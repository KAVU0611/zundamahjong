...
export const ZundamonQuotes: Record<ZundaQuoteCategory, string[]> = {
  ...
  SAFE_TILE: [
    ...
    'とりあえず現物っと。……君、必死な顔してツモってるけど、まさかまだアガれないの？',
  ],
  EARLY_GAME: [
  ...
  DRAW_TENPAI: [
    'あぶなかったねー！ あと一巡あったら君、飛んでたよ？ ボクの手、倍満確定だったんだから。命拾いしてよかったね、雑魚運だけはいいのだ。',
  ],
  DRAW_NOTEN: [
  ...
  PLAYER_WIN_LOW: [
    'その1000点のためにボクの手を蹴ったの？ コスパ悪すぎなのだ。',
    '必死に鳴いてそれ？ 駄菓子代にもならないのだw',
  ],
  PLAYER_WIN_HIGH: [
    'はいはい、よかったねー。すごいすごい（棒）。これで満足なのだ？',
    'へー、満貫？ おめでとうなのだ。……まさか、たかがゲームの点数で人生勝った気になってないよね？',
